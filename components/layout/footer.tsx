...
import { Facebook, Twitter, Linkedin, Youtube, Mail, Phone, MapPin, ArrowRight, Send, ChevronDown } from "lucide-react"
    ...
    <footer className="border-t bg-gradient-to-b from-muted/30 to-muted/50">
      <div className="container mx-auto px-4 py-8 md:py-12 lg:px-8">
        ...
        <motion.div 
          ...
          className="mb-8 md:mb-12 rounded-xl bg-primary p-4 sm:p-6 lg:p-8"
        >
          <div className="grid gap-4 md:gap-6 lg:grid-cols-2 lg:items-center">
            <div>
              <h3 className="font-serif text-lg sm:text-xl md:text-2xl font-bold text-primary-foreground">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2">
              <Input
                ...
                className="bg-background/10 border-primary-foreground/20 text-primary-foreground placeholder:text-primary-foreground/50 text-sm md:text-base"
                required
              />
              <Button 
                type="submit" 
                variant="secondary"
                className="gap-2 whitespace-nowrap w-full sm:w-auto text-sm md:text-base"
        ...
        <div className="block lg:hidden space-y-1">
          ...
          >
            ...
            <div className="space-y-3 mb-8">
              ...
              >
                ...
                <span className="break-all">juidiciallegalways@gmail.com</span>
              </a>
              <a 
          ...
          <MobileAccordion title="Case Files">
            <ul className="space-y-2.5">
              {footerLinks.study.map((link) => (
                <li key={link.name}>
                  <Link 
                    href={link.href} 
                    className="text-sm text-muted-foreground transition-colors hover:text-primary flex items-center gap-2 group py-2"
                  >
        ...
        {/* Desktop Grid View */}
        <div className="hidden lg:grid gap-8 sm:grid-cols-2 lg:grid-cols-6">
          {/* Brand Section */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.div 
          ...
          className="mt-8 md:mt-12 border-t pt-6 md:pt-8"
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 md:gap-6">
            ...
            <div className="flex flex-col items-center gap-1 md:gap-2 text-center order-1 sm:order-2">
            ...
            <div className="flex items-center gap-2 md:gap-3 order-3">
              {socialLinks.map((social) => (
                ...
                >
                  <Link
                    href={social.href}
                    className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center rounded-lg bg-muted text-muted-foreground transition-colors hover:bg-primary hover:text-primary-foreground"
